...
GeneticalAlgorithm::GeneticalAlgorithm(Data data, bool generational, bool position)
{
...
void GeneticalAlgorithm::Generational(Data &data, bool position)
{
...
void GeneticalAlgorithm::Estational(Data &data, bool position)
{
    max_iterations = 50;    // Initial poblation
...
Solution GeneticalAlgorithm::SelectionTournament()
{
    // Selection
...
Solution GeneticalAlgorithm::Cross_position(Data &data, Solution &parent1, Solution &parent2)
{
    Solution child;
...
Solution GeneticalAlgorithm::Cross_OX(Data &data, Solution &parent1, Solution &parent2)
{
...
Solution GeneticalAlgorithm::getSolution() const
{
    return final_solution;
}

float GeneticalAlgorithm::getTime() const
{
    return ((float)time)/CLOCKS_PER_SEC;
}

int GeneticalAlgorithm::getNumGenerations() const
{
