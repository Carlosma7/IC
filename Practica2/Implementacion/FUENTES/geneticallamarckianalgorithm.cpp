...
GeneticalLamarckianAlgorithm::GeneticalLamarckianAlgorithm(Data data, bool generational, bool position)
{
...
void GeneticalLamarckianAlgorithm::Generational(Data &data, bool position)
{
    ...
    while(max_iterations < 50000){
    	// Local search for lamarckian variable of the algorithm
        for(Solution sol:poblation){
        	Local_Search local_search(data, sol);
        	sol = local_search.getSolution();
        }
...
void GeneticalLamarckianAlgorithm::Estational(Data &data, bool position)
{
    max_iterations = 50;    // Initial poblation
    ...
    while(max_iterations < 50000){
        ...
        for(unsigned int i=0; i<poblation.size(); i++){
        	...
        	poblation[i].set_solution(local_search.getSolution().get_solution());
        }
...
Solution GeneticalLamarckianAlgorithm::SelectionTournament()
{
    // Selection
...
Solution GeneticalLamarckianAlgorithm::Cross_position(Data &data, Solution &parent1, Solution &parent2)
{
    Solution child;
...
Solution GeneticalLamarckianAlgorithm::Cross_OX(Data &data, Solution &parent1, Solution &parent2)
{
...
Solution GeneticalLamarckianAlgorithm::getSolution() const
{
    return final_solution;
}

float GeneticalLamarckianAlgorithm::getTime() const
{
    return ((float)time)/CLOCKS_PER_SEC;
}

int GeneticalLamarckianAlgorithm::getNumGenerations() const
{
